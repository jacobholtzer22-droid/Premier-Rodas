...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    icon: Leaf,
    image: '/images/gallery/rodas-025.jpg',
    imageAlt: 'American flag over a freshly maintained lawn and curved landscaped bed at golden hour',
    features: [
  ...
  },
  {
    ...
    icon: Snowflake,
    image: '/images/gallery/rodas-277.jpg',
    imageAlt: 'Rodas Premier plow truck with its blade down, actively plowing a snow-covered street between townhomes during a Michigan snowfall',
    features: [
